  ...
  return (
    <section style={{ padding: "120px 48px" }}>
      <div style={{ maxWidth: 1400, margin: "0 auto" }}>
        <div className="flex flex-col md:flex-row" style={{ gap: 80 }}>
          <div className="w-full md:w-[55%]">
            <div
              style={{
                ...
                minHeight: 450,
                borderRadius: 40,
                backgroundImage: `url(${CALCULATOR.imageUrl})`,
          ...
          <div className="w-full md:w-[45%]" style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <p style={{ fontSize: 16, fontWeight: 600, lineHeight: 1.7, color: "#333", marginBottom: 40 }}>
              Ahorra tiempo, reduce desperdicios y comienza tu proyecto con la cantidad exacta de pintura.
            </p>
            <div>
              <Link
        ...
        <p style={{ marginTop: 48, textAlign: "center", fontSize: 12, lineHeight: 1.7, color: "#737373" }}>
